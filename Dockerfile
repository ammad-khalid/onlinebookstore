...
RUN cd /usr/local/tomcat/webapps/ && wget http://${USER}:${PASSWD}@20.74.182.192:8081/repository/cp4i-project/onlinebookstore-${BUILD_ID}/v1/onlinebookstore-${BUILD_ID}-v1.war
