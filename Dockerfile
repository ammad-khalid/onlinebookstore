...
ARG nexus-jenkins-user-credentials
RUN echo ${BUILD_ID}
#worked#
...
RUN cd /usr/local/tomcat/webapps/ && wget http://${nexus-jenkins-user-credentials}@20.74.182.192:8081/repository/cp4i-project/onlinebookstore-${BUILD_ID}/v1/onlinebookstore-${BUILD_ID}-v1.war
